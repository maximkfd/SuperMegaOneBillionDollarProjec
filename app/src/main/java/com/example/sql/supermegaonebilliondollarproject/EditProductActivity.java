...
public class EditProductActivity extends Activity {
    ...
    private static final String url_all_products = "http://"+JSONParser.IP+"/get_product_details.php";

    // url для обновления продукта
    private static final String url_update_product = "http://"+JSONParser.IP+"/update_product.php";

    // url для удаления продукта
    private static final String url_delete_product = "http://"+JSONParser.IP+"/delete_product.php";
